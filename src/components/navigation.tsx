...
import { BookOpen, Plus, Library, RotateCcw, Menu, Home, User, LogOut, Settings } from "lucide-react"
...
export default function Navigation() {
  ...
  const navItems = [
    ...
    { href: "/my-books", label: "My Books", icon: Library, protected: true },
    { href: "/borrowed", label: "Borrowed", icon: RotateCcw, protected: true },
  ]

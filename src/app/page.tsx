			...
			<div className='bg-gradient-to-r from-emerald-600 to-teal-600 text-white py-20'>
				<div className='container mx-auto px-4 text-center'>
					...
					<p className='text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto'>
						Share knowledge, build community, learn together.
						Connect with neighbors and discover amazing books in
						your area.
					</p>
				...
				<div className='container mx-auto px-4'>
					<div className='text-center mb-16'>
						...
						<p className='text-xl text-gray-600 max-w-3xl mx-auto'>
							...
							to begin sharing and borrowing books.
						</p>
					</div>
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
						<div className='text-center'>
							...
							<p className='text-gray-600'>
								Create your account and verify your email to
						...
						<div className='text-center'>
							...
							<p className='text-gray-600'>
								Add books you&apos;d like to share with details
								and photos to attract borrowers.
							</p>
						</div>
						<div className='text-center'>
							...
							<p className='text-gray-600'>
								Browse, borrow, and lend books while building
			...
			<div className='py-20 bg-gradient-to-r from-emerald-600 to-teal-600 text-white'>
				<div className='container mx-auto px-4 text-center'>
					...
					<p className='text-xl mb-8 opacity-90 max-w-2xl mx-auto'>
						Join thousands of book lovers who are already building
						stronger communities through reading.
					</p>
